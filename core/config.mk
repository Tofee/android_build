...
BUILD_JAVA_LIBRARY:= $(BUILD_SYSTEM)/clear_vars.mk
BUILD_STATIC_JAVA_LIBRARY:= $(BUILD_SYSTEM)/clear_vars.mk
...
BUILD_HOST_DALVIK_JAVA_LIBRARY := $(BUILD_SYSTEM)/clear_vars.mk
BUILD_HOST_DALVIK_STATIC_JAVA_LIBRARY := $(BUILD_SYSTEM)/clear_vars.mk
